...
module.exports = class Level {
  ...
  findBounds () {
    for (const coords in this[_chunks]) {
      this[_chunkX][0] = Math.min(this[_chunks][coords].X, this[_chunkX][0])
      this[_chunkX][1] = Math.max(this[_chunks][coords].X, this[_chunkX][1])

      this[_chunkZ][0] = Math.min(this[_chunks][coords].Z, this[_chunkZ][0])
      this[_chunkZ][1] = Math.max(this[_chunks][coords].Z, this[_chunkZ][1])
    }
